import './house.css';
const House = () => {
    return ( <svg className="house" width="200" height="200" viewBox="-100 -100 200 200">
    <polygon className="wall" points="-65,80 -65,-10 0,-70 65,-10 65,80" />
    <polyline className="roof" points="-75,-8 0,-78 75,-8" />
  
    <rect className="door" x="-45" y="10" width="30" height="60" />
    ...
    <rect className="window" x="5" y="15" width="40" height="35" />
    <line x1="5" y1="32.5" x2="45" y2="32.5" />
    <line x1="25" y1="15" x2="25" y2="50" />
    <rect className="window-sill" x="2" y="48" width="46" height="5" />
