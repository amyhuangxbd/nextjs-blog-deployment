...
export default function Cannon(props) {
  const group = useRef();
  const { nodes, materials } = useGLTF("/nextjs-blog-deployment/models/cannon-mobile/model.gltf");
...
useGLTF.preload("/nextjs-blog-deployment/models/cannon-mobile/model.gltf");
