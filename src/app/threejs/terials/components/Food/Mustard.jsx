...
export function Mustard(props) {
  const group = useRef();
  const { nodes, materials } = useGLTF("/nextjs-blog-deployment/models/bottle-musterd/model.gltf");
  return (
...
useGLTF.preload("/nextjs-blog-deployment/models/bottle-musterd/model.gltf");
