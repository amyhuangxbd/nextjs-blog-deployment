...
export function Cauldron(props) {
  const group = useRef();
  const { nodes, materials } = useGLTF("/nextjs-blog-deployment/models/cauldron/model.gltf");
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      ></mesh>
      <mesh geometry={nodes.Sphere015_2.geometry}>
...
useGLTF.preload("/nextjs-blog-deployment/models/cauldron/model.gltf");
