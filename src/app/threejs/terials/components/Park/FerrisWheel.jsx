...
export function FerrisWheel(props) {
  const { nodes, materials } = useGLTF("/nextjs-blog-deployment/models/ferris-wheel/model.gltf");
...
useGLTF.preload("/nextjs-blog-deployment/models/ferris-wheel/model.gltf");
